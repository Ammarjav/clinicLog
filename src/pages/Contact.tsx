...
import { ArrowLeft, MessageCircle, Mail, Phone, Sparkles } from 'lucide-react';
...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFF] dark:bg-slate-950 flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden transition-colors duration-500">
      {/* Background Blurs */}
      ...
      >
        <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white dark:bg-slate-900 shadow-md border border-slate-100 dark:border-slate-800 flex items-center justify-center group-hover:bg-indigo-50 dark:group-hover:bg-indigo-900/20">
          <ArrowLeft size={18} />
        </div>
        <span className="hidden md:block">Back to Home</span>
      </Link>

      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center animate-in fade-in slide-in-from-bottom-4 duration-700 mt-12 md:mt-0">
