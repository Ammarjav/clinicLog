...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFF] selection:bg-indigo-100 overflow-x-hidden scroll-smooth">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="relative max-w-5xl mx-auto animate-in zoom-in-95 duration-1000 px-2 md:px-0">
            ...
            <div className="relative bg-white/40 backdrop-blur-sm p-2 md:p-4 rounded-3xl md:rounded-[3rem] border border-white shadow-2xl overflow-hidden group">
              ...
              <img 
                src="https://images.unsplash.com/photo-1504813184591-01592fd039e5?auto=format&fit=crop&q=80&w=2000" 
      ...
      {/* Bento Grid Features - UPDATED TO SHOW REAL FEATURES */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4 md:gap-6 px-2">
            ...
            <div className="md:col-span-4 bg-white p-8 md:p-10 rounded-3xl md:rounded-[3rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all group overflow-hidden relative">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl font-black text-slate-900 mb-3 md:mb-4 tracking-tight">Professional Reports</h3>
            ...
            <div className="md:col-span-2 bg-indigo-50 p-8 md:p-10 rounded-3xl md:rounded-[3rem] border border-indigo-100">
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl md:rounded-2xl bg-white flex items-center justify-center mb-6 md:mb-8">
                <MousePointer2 className="w-6 h-6 md:w-7 md:h-7 text-indigo-600" />
              </div>
              <h3 className="text-xl md:text-2xl font-black text-slate-900 mb-3 md:mb-4 tracking-tight">Smart Entry</h3>
            ...
            {/* Live Analytics */}
            <div className="md:col-span-4 bg-white p-8 md:p-10 rounded-3xl md:rounded-[3rem] border border-slate-100 shadow-sm flex flex-col md:flex-row gap-8 items-center overflow-hidden relative">
              <div className="flex-1 text-center md:text-left relative z-10">
                ...
                <h3 className="text-xl md:text-2xl font-black text-slate-900 mb-3 md:mb-4 tracking-tight">Live Analytics</h3>
              ...
              <div className="hidden sm:flex justify-center flex-1">
                <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100 w-full rotate-2">
                  ...
                  <div className="space-y-3">
                    <div className="h-4 bg-indigo-100 rounded-full w-[80%]" />
                    <div className="h-4 bg-emerald-100 rounded-full w-[60%]" />
      ...
      <footer className="py-12 md:py-20 border-t border-slate-50 bg-white px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <p className="text-[10px] md:text-xs text-slate-400 font-medium tracking-wide uppercase">The clinical logging standard.</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-12 text-xs md:text-sm font-bold text-slate-400">
            ...
            <a href="#features" className="hover:text-indigo-600 transition-colors uppercase tracking-widest">Features</a>
