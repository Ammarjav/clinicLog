    ...
    <div className="min-h-screen bg-[#FDFDFF] dark:bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium">Access your clinical portal</p>
        </div>

        <div className="bg-white dark:bg-slate-900 p-8 md:p-10 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-2xl shadow-indigo-100/20 dark:shadow-none">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-slate-500">Email Address</FormLabel>
                    <FormControl>
                      <div className="relative">
                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-300 dark:text-slate-600" />
                        <Input placeholder="dr.smith@clinic.com" className="h-14 rounded-2xl pl-12 bg-slate-50/50 dark:bg-slate-800/50 border-slate-100 dark:border-slate-800 focus:bg-white dark:focus:bg-slate-800 focus:ring-indigo-500/20 dark:text-white transition-all text-base" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-slate-500">Password</FormLabel>
                    <FormControl>
                      <div className="relative">
              ...
              <Button 
                type="submit" 
                className="w-full h-14 text-base font-bold rounded-2xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-indigo-600 dark:hover:bg-indigo-400 shadow-lg shadow-slate-200 dark:shadow-none transition-all active:scale-[0.98]"
              ...
              <div className="text-center pt-2">
                <p className="text-sm text-slate-400 dark:text-slate-500 font-medium">
                  ...
                  <Link to="/admin/signup" className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline underline-offset-4">
                    Register Now
                  </Link>
                </p>
              </div>
