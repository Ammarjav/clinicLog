...
const Terms = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFF] dark:bg-slate-950 flex flex-col items-center py-20 px-6 relative overflow-hidden transition-colors duration-500">
      {/* Background Blurs */}
      ...
      <div className="w-full max-w-4xl space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 mt-16 md:mt-24">
        ...
        <p className="text-center text-[10px] font-black text-slate-300 dark:text-slate-700 uppercase tracking-[0.3em] mt-12">
