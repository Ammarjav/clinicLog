    ...
    <div className="max-w-2xl mx-auto p-5 sm:p-8 bg-white rounded-[2rem] shadow-xl border border-gray-100">
      <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500 text-xs sm:text-sm mt-1 sm:mt-1.5">Rapid demographic data submission</p>
        </div>
      </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Full Name" className="rounded-xl h-11 sm:h-12" {...field} value={field.value || ''} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
